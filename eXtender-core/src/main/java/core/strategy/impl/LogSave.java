 ...
 * @version  %I%, %G% 
 */
public class LogSave implements IStrategy {
    ...
    public String process(DomainEntity entity) {
    	...
    	//codigo para verificar se processo de salvar pode ou não ser realizado.
    	
    	 Logger logger = LoggerFactory.getLogger(entity.getClass().getSimpleName());    	 
		 logger.info("Processo inválido. Não é possível executar esta ação de salvar."); 

 ...
 * @version  %I%, %G% 
 */
public class LogUpdate implements IStrategy {
    ...
    public String process(DomainEntity entity) {
    	...
    	//codigo para verificar se processo de alteração pode ou não ser realizado.
    	
    	 Logger logger = LoggerFactory.getLogger(entity.getClass().getSimpleName());    	 
		 logger.info("Processo inválido. Não é possível executar esta ação de alteração."); 

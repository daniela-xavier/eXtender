 ...
 * @version  %I%, %G% 
 */
public class LogDisable implements IStrategy {
    ...
    public String process(DomainEntity entity) {
    	...
    	//codigo para verificar se processo de disabilitar pode ou não ser realizado.
    	
    	 Logger logger = LoggerFactory.getLogger(entity.getClass().getSimpleName());    	 
		 logger.info("Processo inválido. Não é possível executar esta ação de desabilitar."); 
